...
const NODES: TelemetryNode[] = [
  {
    ...
    version: "hmac-sha256",
    change: "X-Razorpay-Signature validation",
    status: "CI VERIFIED",
  },
  {
    index: "02",
    ...
    version: "v2.9.2",
    change: "paise integer calculation repair",
    status: "AUTO-PATCHED",
  },
  {
    index: "03",
    name: "checkout telemetry",
    version: "order_total_mismatch",
    change: "expected ₹999 vs actual ₹950",
    status: "PR GENERATED",
  },
  {
    index: "04",
    name: "razorpay test mode",
    version: "transient-timeout",
    change: "tier-1 bounded recovery (₹500.00)",
    status: "RECOVERED",
  },
];
